  ...
  return (
    <div className="container mx-auto relative h-screen w-screen flex items-center justify-center">
      <div className="flex flex-col gap-2">
        <TextStagger className="text-8xl font-bold text-zinc-200">
        ...
        <div className="mt-6 flex items-center space-x-4">
          <button className="bg-zinc-900 py-2 px-4">
            <span className="uppercase font-medium text-xs text-zinc-200">
              View Works
            </span>
          </button>
          <button className="bg-zinc-300 py-2 px-4">
            <span className="uppercase font-medium text-xs text-zinc-900">
              Resumé
            </span>
          </button>
        </div>
